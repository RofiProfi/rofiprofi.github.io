...
class ControllerRacun{
	...
	function narudzbenica(){
	   ...
	   if(isset($_POST['kartica'])){
	       $nacinPlacanja= $_POST['kartica'];}else{$msg4="izaberite nacin placanja";}
	        ...
	        if(is_numeric($postanskiBroj)){
	            if(is_numeric($telefon)){
	                if(is_numeric($brojRacuna)){
	                    ...
	                    foreach($ukupno as $u){
	                        $Ukupno= $u['SUM(kolica_kolicina*proizvod_cena)'];
	                    }
	                    
	                   
	                    
	                    
	                    $dao->insertNarudzbe($_SESSION['ulogovan']["korisnik_id"], $ime,$prezime,$email, $adresa,$grad,$drzava,$postanskiBroj,$telefon, $Ukupno,$brojRacuna,$nacinPlacanja);
	                    $dao->insertLista();
	                        ...
	                        $ukupno=$dao->ukupno($_SESSION['ulogovan']["korisnik_id"]);
	                        foreach($kupa as $kup){
	                            $msg= "Ime: ".$kup["ime"]."<br>"."Prezime: ".$kup["prezime"]. "<br>"."Email: ".$kup["email"]. " <br>"."Adresa: ".$kup["adresa"]. " <br>"."Grad: ".$kup["grad"]. "<br> "."Drzava: ".$kup["drzava"]. "<br> "."Postanski broj: ".$kup["postanskiBroj"]. " <br>"."Broj telefona: ".$kup["telefon"]." <br>"."Broj Racuna: ".$kup["brojRacuna"]. " <br>"."Nacin Placanja: ".$kup["nacinPlacanja"]. " <br>"."Ukupan iznos: ".$Ukupno. " <br>". "Datum narucivanja: " .$kup["datumNarucivanja"]. " <br>";
	                        }
	                ...
	                else{ $msg4="Broj racuna mora biti broj";
	                include 'racun.php';}
	            }else{ $msg4="Telefon mora biti broj";
	            include 'racun.php';}
	        }else{ $msg4="Postanski broj mora biti broj";
	        include 'racun.php';}
